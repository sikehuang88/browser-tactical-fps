...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /api/v1/tracers", s.requireAuth(s.handleTracers))
	mux.HandleFunc("POST /api/v1/tracers/{itemID}/purchase", s.requireAuth(s.handlePurchaseTracer))
	mux.HandleFunc("POST /api/v1/tracers/{itemID}/equip", s.requireAuth(s.handleEquipTracer))
